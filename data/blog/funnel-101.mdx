...
friends; but not everyone else. This is great when you're testing things with
your coworkers or playing Minecraft with your friends, but sometimes you need
to test things against the real world. Tailscale Funnel allows you to expose
your local services to the public Internet.

Today I'm going to walk you through the basics of funnel and show you how to
use it with a live demo.
...
- A development machine running Linux, macOS, or Windows
  - Be sure [funnel is enabled in the tailnet policy file
    settings](https://tailscale.com/kb/1223/tailscale-funnel/) for that machine
- [Deno](https://deno.land) installed on your development machine

<HeroImage
  src="/images/hero/lagtrain.png"
  desc="train station, brown hair, brown eyes, face mask, portrait, backpack, hoodie, watercolor"
  width={1280}
  height={512}
...
to make. Open a terminal on your developer machine, and run this command:
...
```json
{
  // the rest of the file
  "std/": "https://deno.land/std@0.178.0/",
  "$tswebhook": "https://gist.githubusercontent.com/Xe/93b5c95a90aaa3f71ca148e87d16f768/raw/5a52db30b05a5bf014d9fac85df51ed0b3f12805/mod.ts"
}
```
