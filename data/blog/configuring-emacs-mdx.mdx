...
tags:
  - 'emacs'
  - 'mdx'
summary: 'This blog uses a lot of modern technologies like MDX, Xe uses Emacs, which nobody has implemented MDX support for. In this article Xe gets MDX support working anyways through the use/abuse of directory-local variables in Emacs so you can do this too.'
---
...
closed](https://github.com/mdx-js/mdx/issues/119). This should mean
that I'm out of luck and need to architect a whole new major mode for
Emacs.

<HeroImage
  src="/images/hero/fantasy-landscape.png"
  desc="masterpiece, digital art, watercolor, landscape, badlands, mountains"
  width={1280}
  height={512}
