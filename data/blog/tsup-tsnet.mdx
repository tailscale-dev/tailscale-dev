...
<Figure
  src="/images/tsup-tsnet/002.jpeg"
  width={1280}
  height={720}
  alt={`The slide changes to a rope stretched between the words "complexity" and "simplicity", as if it is some kind of tug-of-war between the two opposing forces, each represented by AI generated anime characters. The side labeled "simplicity" is depicted as on the verge of losing, as is normal for these tradeoffs.`}
/>
...
<Figure
  src="/images/tsup-tsnet/003.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows some crappy server png with a box around it and gitlab/wikimedia logos.`}
/>
...
<Figure
  src="/images/tsup-tsnet/005.jpeg"
  width={1280}
  height={720}
  alt={`A rather exasperated anthropomorphic orca character with pink hair holds a coffee mug.`}
/>

Ask me how I know.

<Figure
  src="/images/tsup-tsnet/006.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows an angry green-haired anime character sitting in front of alaptop, attempting to hold back her anger from being exacted on the poor device.`}
/>
...
<Figure
  src="/images/tsup-tsnet/007.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows an anime depiction of a radio tower on a hill with the Space Needle in the background.`}
/>

So how can we make things simple again?

<Figure
  src="/images/tsup-tsnet/008.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows the character N from Xenoblade Chronicles 3 standing in front of a fork in a path with his wife on the right-hand side. This evokes the mood of buddhist philosophy's concept of attempting to find the middle path between two extremes.`}
/>

What's the middle path between these two extremes of pain?

<Figure
  src="/images/tsup-tsnet/009.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows the character N from Xenoblade Chronicles 3 standing in front of a path that goes straight down the middle, implying that the middle path between extremes of pain has been found and thus true healing can happen.`}
/>
...
<Figure
  src="/images/tsup-tsnet/010.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows background for the speaker Xe iaso. It notes that Xe is the Archmage of Infrastructure at Tailscale, a prolific blogger, philosopher, and network criminal.`}
/>
...
<Figure
  src="/images/tsup-tsnet/011.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows the number 44 in large text with the subtitle "Tailnet nodes".`}
/>

When I made the slides for this talk, this is the number of devices that are in my husband and I's tailnet. I'm a heavy user of Tailscale and it's made so many things so much simpler when it comes to making and sharing internal services.

<Figure
  src="/images/tsup-tsnet/012.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows the number 14 in large text with the subtitle "tsnet services".`}
/>
...
<Figure
  src="/images/tsup-tsnet/013.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows the word "tsnet" in large text.`}
/>
...
<Figure
  src="/images/tsup-tsnet/014.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows a green-haired anime character walking down an idyllic countryside path next to a river away from some kind of cabin.`}
/>
...
<Figure
  src="/images/tsup-tsnet/015.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows the word "XeDN" in large text.`}
/>
...
<Figure
  src="/images/tsup-tsnet/016.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows a rather large thinking emoji.`}
/>
...
<Figure
  src="/images/tsup-tsnet/017.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows an anthropomorphic shark with brown/red hair looking pensive with the word "CDN?" next to her in large text.`}
/>
...
<Figure
  src="/images/tsup-tsnet/018.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows the same image of an anthropomorphic shark with brown/red hair looking pensive.`}
/>
...
<Figure
  src="/images/tsup-tsnet/020.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows large emoji of a woman running with a puff of smoke behind her.`}
/>
...
<Figure
  src="/images/tsup-tsnet/021.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows the number 0 in large text with the subtitle "patient zero".`}
/>
...
<Figure
  src="/images/tsup-tsnet/022.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows the Mastodon logo, a blue speech bubble with a white letter "m" inside it, the overall design evokes the shape of an elephant.`}
/>
...
<Figure
  src="/images/tsup-tsnet/023.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows the Robocadey profile from the official Mastodon app.`}
/>
...
<Figure
  src="/images/tsup-tsnet/025.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows the Stable Diffusion webui with some interestingly titled tabs in the sidebar: "have you ever been far", "why do birds fly", "best restaurants SF", "take screenshot mac". This references a dead internet meme where you put weird browser tab titles in otherwise normal screenshots.`}
/>
...
<Figure
  src="/images/tsup-tsnet/026.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows the nVidia "RTX ON" logo.`}
/>
...
<Figure
  src="/images/tsup-tsnet/027.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows three alarm emoji.`}
/>
...
<Figure
  src="/images/tsup-tsnet/028.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows the fly.io logo.`}
/>

Either way, I run this bot in fly.io. fly doesn't have gpu nodes
available yet, so I needed some kind of bridge or way to connect the
...
<Figure
  src="/images/tsup-tsnet/029.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows the Stable Diffusion webui with the Tailscale logo overlaid on the upper left corner. This also obscures the tab title meme. Such is life.`}
/>
...
<Figure
  src="/images/tsup-tsnet/030.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows a green-haired anime girl in a battle dress roughly imitating the pose that Borat makes in the popular meme format of "Great success!". The text at the bottom was generated by Stable Diffusion and roughly reads as "Pieat Surless", which is remarkably legibly. This is rare for AI generated images.`}
/>
...
So when the bot runs somewhere in Fly, it can hit the Stable
Diffusion UI over Tailscale and then be able to respond to queries
within seconds. I've done some performance monitoring of it and the longest part seems to be the image generation step, which can only really get faster if I upgrade the GPU in the homelab node in
question (assuming that Nvidia's pricing scheme comes back to earth). I also serve the Stable Diffusion WebUI over Tailscale so that I can generate new images with my macbook, ipad, gaming tower, or
any other device on my tailnet.
...
<Figure
  src="/images/tsup-tsnet/033.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows a green haired anime character in a black hoodie absolutely incensed with anger throb emoji above her left temple.`}
/>
...
<Figure
  src="/images/tsup-tsnet/034.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows the logo for the monitoring application Prometheus, the overall design evokes a torch lit on fire, poking fun at Prometheus' role in Greek mythology for stealing fire from the gods and giving it to men.`}
/>
...
<Figure
  src="/images/tsup-tsnet/035.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows the wordmark for Grafana. It contains a orange/yellow swirl that roughly evokes the design of a tentacle.`}
/>
...
<Figure
  src="/images/tsup-tsnet/037.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows a grafana server named "chrysalis" selected in the menus that spawn from the Tailscale menulet on macos.`}
/>
...
<Figure
  src="/images/tsup-tsnet/038.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows some random charts on Grafana.`}
/>
...
<Figure
  src="/images/tsup-tsnet/041.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows a heart-shaped lock with a key.`}
/>
...
<Figure
  src="/images/tsup-tsnet/042.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows a green-haired anime character doing some brand of magic and making pages from books fly around chaotically.`}
/>
...
<Figure
  src="/images/tsup-tsnet/043.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows a clipboard emoji.`}
/>
...
<XesiteConv name="Mara" mood="hacker">
  This isn't a bit. This is something that actually happened.
</XesiteConv>

<Figure
  src="/images/tsup-tsnet/044.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows a pensive green-haired anime character.`}
/>
...
<Figure
  src="/images/tsup-tsnet/045.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows the word "tclip" in rather large text.`}
/>
...
<Figure
  ...
  width={1280}
  height={720}
  alt={`The slide shows a bunch of filler words, making Xenoblade jokes that would take too long to explain. If you get it, you get it.`}
/>
...
<Figure
  src="/images/tsup-tsnet/050.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows the Funnel logo, a lot of chaotic circles in a physics simulation that makes things look like they are being funneled down to a single point.`}
/>
...
<Figure
  src="/images/tsup-tsnet/051.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows three lock emoji.`}
/>
...
<Figure
  src="/images/tsup-tsnet/054.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows three certificate emoji.`}
/>

Another great part about using tsnet for this is that it makes
using HTTPS so trivial it's almost funny. With only a few extra lines
of code I have an HTTPS service inside my tailnet. Tailscale's Let's
Encrypt support takes care of that for me so I don't have to do it
manually. It's magic.
...
<Figure
  src="/images/tsup-tsnet/055.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows that same anthro shark from before, pensive as usual.`}
/>
...
<Figure
  src="/images/tsup-tsnet/056.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows that orca character again desperately clutching to her coffee in hopes that it makes the bad things go away sooner.`}
/>
...
<Figure
  src="/images/tsup-tsnet/058.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows a crying emoji.`}
/>
...
<Figure
  src="/images/tsup-tsnet/059.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows an anime character in the artstyle of Genshin Impact working on a laptop by the Space Needle.`}
/>
...
We're just wrapping Tailscale' Go code into a C library.

<Figure
  src="/images/tsup-tsnet/061.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows "libtailscale" in large text.`}
/>
...
<Figure
  src="/images/tsup-tsnet/063.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows the logos for the programming languages Python and Ruby.`}
/>
...
<Figure
  src="/images/tsup-tsnet/066.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows "XeDN", "robocadey2", "tclip", and "libtailscale".`}
/>
...
<Figure
  src="/images/tsup-tsnet/073.jpeg"
  width={1280}
  height={720}
  alt={`The slide shows a waving hand emoji, Xe's sigil, the email
  address tsnetup@xeserv.us, and a link to https://xeiaso.net.`}
/>
...
to you, please email tsnetup at xe serv dot us and I'll be more than
