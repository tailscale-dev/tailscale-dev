...
date: 2023-04-01
summary: Xe goes over how they made a pastebin tool for your tailnet that wouldn't be possible without Tailscale.
authors: ['xe']
tags:
  - tsnet
  - funnel
...
<HeroImage
  width={1280}
  height={512}
  generator="Anything v3.0"
  desc="1girl, headphones, brown hair, brown eyes, apartment, sitting, laptop, indoors, happy, laptop"
  src="/images/hero/remote-work-vibes.png"
/>
...
We hope you enjoy using tea clip! We've been working hard on it to make it a tool that you can rely on, as well as a way to explain advanced ways of using Tailscale.
