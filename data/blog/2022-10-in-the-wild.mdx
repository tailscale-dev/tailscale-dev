...
[Read more](https://www.vshn.ch/blog/vshn-hackday-tailscale-on-appuio-cloud/) about how as part of VSHN #HackDay Twitter users [@tobruzh](https://twitter.com/tobruzh) and [@__simu__](https://twitter.com/__simu__)figured out how to use Tailscale on APPUiO Cloud. More about how it works [in the docs](https://docs.appuio.cloud/user/how-to/tailscale.html).
